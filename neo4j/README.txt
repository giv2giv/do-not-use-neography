...
Welcome to Neo4j release 1.8.2, a high-performance graph database.
...
* [Getting Started](http://docs.neo4j.org/chunked/1.8.2/introduction.html)
* [The Neo4j Manual (online)](http://docs.neo4j.org/chunked/1.8.2/)
